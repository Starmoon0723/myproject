...
def main() -> int:
    ...
    try:
        ...
        video_request_id = "aa0b8accc00b444d845216d747c51339"
        ...
        try:
            video_cb = _poll_get(f"https://sit-saas-zzbank-ala-hub.qifudigitech.com/callback/video-guidance/{video_request_id}", timeout_sec=60)
        except Exception as e:
