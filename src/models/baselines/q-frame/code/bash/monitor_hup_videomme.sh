...
# 日志
# -----------------------------
LOG_DIR="/data/oceanus_share/shangshouduo-jk/myproject/output/logs/baselines/q-frame/longclip/videomme"
mkdir -p "$LOG_DIR"
...
QFRAME_MANIFEST="/data/oceanus_share/shangshouduo-jk/myproject/data/processed/Video-MME/baselines/q-frame/selected_frames_manifest.jsonl"
