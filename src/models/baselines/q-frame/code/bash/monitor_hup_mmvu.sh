...
# 日志
# -----------------------------
LOG_DIR="/data/oceanus_share/shangshouduo-jk/myproject/output/logs/baselines/q-frame/longclip/mmvu"
mkdir -p "$LOG_DIR"
...
QFRAME_MANIFEST="/data/oceanus_share/shangshouduo-jk/myproject/data/processed/MMVU/baselines/q-frame/selected_frames_manifest.jsonl"
