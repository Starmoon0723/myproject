...
# # 输入 TSV 路径
# TSV_PATH="/data/oceanus_share/shangshouduo-jk/project/datasets/Video-MME/Video-MME_only_question.tsv"

# # 输出根目录
# OUTPUT_ROOT="$PROJECT_ROOT/data/processed/$DATASET_NAME/baselines/q-frame"

# ==============================================================================
# q-frame 核心超参数 (与论文源码对齐)
# ==============================================================================
MAX_FRAMES=128
FPS=1.0
HIGH_F=4
