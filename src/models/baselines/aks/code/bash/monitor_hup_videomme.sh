...
# --- 自动日志设置 ---
LOG_DIR="/data/oceanus_share/shangshouduo-jk/myproject/output/logs/baselines/aks/clip/videomme"
mkdir -p "$LOG_DIR"
...
AKS_SAMPLE="/data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/selected_frames/videomme/videomme_clip_64.jsonl"
