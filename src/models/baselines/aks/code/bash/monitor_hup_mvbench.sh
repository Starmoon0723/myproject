...
# --- 自动日志设置 ---
LOG_DIR="/data/oceanus_share/shangshouduo-jk/myproject/output/logs/baselines/aks/clip/mvbench"
mkdir -p "$LOG_DIR"
...
AKS_SAMPLE="/data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/selected_frames/mvbench/clip/selected_frames.jsonl"

# 3. 结果输出目录
OUTPUT_DIR="/data/oceanus_share/shangshouduo-jk/myproject/output/results/baselines/aks/clip"
...
while true; do
    ...
    CUDA_VISIBLE_DEVICES=0,1 python "$INFERENCE_SCRIPT" \
        --nproc "$N_PROC" \
