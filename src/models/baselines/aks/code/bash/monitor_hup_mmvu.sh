...
# --- 自动日志设置 ---
LOG_DIR="/data/oceanus_share/shangshouduo-jk/myproject/output/logs/baselines/aks/clip/mmvu"
mkdir -p "$LOG_DIR"
...
AKS_SAMPLE="/data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/selected_frames/mmvu/clip/selected_frames.jsonl"
