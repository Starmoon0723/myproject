...
SCORE_PATH="/data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/outscores/mmvu/clip/scores.json"
FRAME_PATH="/data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/outscores/mmvu/clip/frames.json"
MAX_NUM_FRAMES=64
RATIO=1
T1=0.8
T2=-100
