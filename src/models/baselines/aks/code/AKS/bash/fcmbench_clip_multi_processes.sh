...
# videomme, mvbench, lvbench, mlvu, mmvu, videommmu, fcmbench
...
CUDA_VISIBLE_DEVICES=0,1 python /data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/feature_extract_new_multi_processes.py \
    ...
    --label_path "/data/oceanus_share/shangshouduo-jk/myproject/data/processed/FCMBench" \
    --video_path "/data/oceanus_share/shangshouduo-jk/myproject/data/processed/FCMBench" \
    --extract_feature_model "clip" \
    --output_file "/data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/outscores/wo_options_multi_process" \
