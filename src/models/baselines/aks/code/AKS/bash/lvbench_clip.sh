...
CUDA_VISIBLE_DEVICES=1 python /data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/feature_extract_new.py \
    --dataset_name "lvbench" \
    --label_path "/data/oceanus_share/shangshouduo-jk/myproject/data/processed/LVBench" \
    --video_path "/data/oceanus_share/shangshouduo-jk/myproject/data/processed/LVBench" \
    --extract_feature_model "clip" \
    --output_file "/data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/outscores/wo_options" \
