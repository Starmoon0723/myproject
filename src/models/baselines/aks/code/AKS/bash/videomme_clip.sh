...
CUDA_VISIBLE_DEVICES=1 python /data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/feature_extract_new.py \
    ...
    --label_path "/data/oceanus_share/shangshouduo-jk/myproject/src/models/baselines/aks/code/AKS/datasets/videomme" \
    --video_path "/data/oceanus_share/shangshouduo-jk/project/datasets/Video-MME/data" \
