...
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/output/results/evs_0.50}"
LOG_DIR="${LOG_DIR:-${PROJECT_ROOT}/output/logs/evs_0.50/videomme}"
...
VIDEO_PRUNING_RATE="${VIDEO_PRUNING_RATE:-0.50}"
