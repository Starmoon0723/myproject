...
# --- 自动日志设置 ---
LOG_DIR="/data/oceanus_share/shangshouduo-jk/myproject/output/logs/backbone/fcmbench"
mkdir -p "$LOG_DIR"
...
# 1. 模型权重路径
MODEL_PATH="/data/oceanus_share/cuirunze-jk/ckpts/Qwen/Qwen3-VL-32B-Instruct" 

# 2. 使用的进程数量
N_PROC=1

# 3. 结果输出目录
OUTPUT_DIR="/data/oceanus_share/shangshouduo-jk/myproject/output/results/backbone"
